        ...
        <div class="page-header clear-filter" filter-color="orange">
            ...
            <div class="container">
                <div class="content-center brand">
                    ...
                    <h5>Viva, sinta, ame, venha aproveitar nossas instalações e as belezas naturais que nos cercam!</h5>
                </div>
            </div>
        </div>
        <div class="main">
                ...
                <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
                  ...
                  <div class="carousel-inner" role="listbox">
                    ...
                    <div class="carousel-item">
                      ...
                      <div class="carousel-caption d-none d-md-block">
                        <h5>Área de Lazer - Hotel Mira-Sol, Arraial do Cabo</h5>
                      </div>
                    </div>
                    <div class="carousel-item">
                ...
                <div class="container">
                    ...
                    <div class="row text-center mt-5">
                        <div class="col-md-8 ml-auto mr-auto">
                            ...
                            <h5 class="description">Maiores informações pelo telefone (22)9999-9999 ou através de nossas redes sociais.</h5>
